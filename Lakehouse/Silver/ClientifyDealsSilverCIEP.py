...
clientify_df = spark.read.json(f"{bronze_folder_path}/lakehouse/clientify/deals/{current_date}/clientifydealsciep.json")
...
clientify_df_final = clientify_df_final \
    ...
    .withColumn("sourcesystem", lit("Clientify CIEP")) \
...
#14/01/2025 - sourcesystem se ha cambiado de Clientify a Clientify CIEP
...
# MAGIC %sql
# MAGIC select * from silver_lakehouse.clientifydeals where sourcesystem LIKE '%Clientify CIEP'
